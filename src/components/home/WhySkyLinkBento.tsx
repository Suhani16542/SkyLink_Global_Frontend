    ...
    <section className="py-20 sm:py-28 bg-white border-t border-neutral-200">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-6">
          {/* Card 1: Large Featured Anchor Card (Spans 7 cols on lg) */}
          <ScrollReveal
            effect="fade-right"
            delay={100}
            duration={700}
            className="lg:col-span-7 rounded-3xl p-8 sm:p-10 bg-gradient-to-br from-[#0A2540] via-[#0B3156] to-[#07192D] text-white shadow-xl flex flex-col justify-between relative overflow-hidden group hover-lift"
          >
          ...
          {/* Card 2: Cost Optimization Card (Spans 5 cols on lg) */}
          <ScrollReveal
            effect="fade-left"
            delay={180}
            duration={700}
            className="lg:col-span-5 rounded-3xl p-8 bg-neutral-50/80 border border-neutral-200 flex flex-col justify-between hover-lift group"
          >
            <div>
          ...
          {/* Card 3: GDP Cold Chain (Spans 4 cols on lg) */}
          <ScrollReveal
            effect="fade-up"
            delay={220}
            duration={700}
            className="lg:col-span-4 rounded-3xl p-7 bg-white border border-neutral-200 shadow-sm flex flex-col justify-between hover-lift group"
          >
            <div>
          ...
          {/* Card 4: Regulatory Mastery (Spans 4 cols on lg) */}
          <ScrollReveal
            effect="fade-up"
            delay={260}
            duration={700}
          ...
          {/* Card 5: Global Telemetry Network (Spans 4 cols on lg) */}
          <ScrollReveal
            effect="fade-up"
            delay={300}
            duration={700}
