      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-stretch">
          ...
          <ScrollReveal effect="fade-up" delay={100} className="md:col-span-12 lg:col-span-4 flex">
            <div className="w-full rounded-3xl p-7 bg-[#0A2540]/80 border border-white/15 backdrop-blur-md flex flex-col justify-between group hover:border-sky-400/50 hover:shadow-2xl hover:shadow-sky-500/10 hover-lift sheen-card transition-all duration-300 relative overflow-hidden">
              <div className="absolute top-0 right-0 w-36 h-36 bg-sky-400/5 rounded-full blur-2xl pointer-events-none" />

              <div>
                <div className="flex items-center justify-between mb-6">
                  <div className="w-13 h-13 rounded-2xl bg-gradient-to-br from-sky-400 to-[#0284C7] text-white flex items-center justify-center shadow-lg shadow-sky-500/25 group-hover:scale-110 group-hover:rotate-1 transition-all duration-300">
                    <Scale className="w-6 h-6" />
                  </div>
                  <span className="text-[10px] font-mono font-bold uppercase tracking-wider text-emerald-400 bg-emerald-950/80 px-2.5 py-1 rounded-full border border-emerald-500/30 shadow-xs">
                    DGFT &amp; FTP Compliance
                  </span>
                </div>

                <h3 className="text-xl font-black text-white tracking-tight mb-2 group-hover:text-sky-300 transition-colors">
                  DGFT Advisory &amp; Export Schemes
                </h3>

                <p className="text-xs sm:text-sm text-neutral-300 leading-relaxed mb-6">
                  Complete advisory and representation before the Directorate General of Foreign Trade to claim statutory export benefits, secure duty exemptions, and ensure zero-defect trade compliance.
                </p>
              ...
              <div className="mt-6 pt-4 border-t border-white/10 flex items-center justify-between text-xs text-sky-300 font-semibold group-hover:text-white transition-colors">
                <span>Explore DGFT Services</span>
          ...
          {/* ------------------------------------------------------------------------- */}
          {/* MODULE 2: Premier Carrier Freight Velocity (Center Visual Hub, 4 Cols) */}
          {/* ------------------------------------------------------------------------- */}
          <ScrollReveal effect="fade-up" delay={200} className="md:col-span-12 lg:col-span-4 flex">
            <div className="w-full rounded-3xl overflow-hidden border border-white/20 shadow-2xl relative bg-[#07192D] group flex flex-col justify-between min-h-[420px] hover-lift transition-all duration-300">
              
              {/* High-Resolution Background Imagery of Ocean Container Port */}
              <Image
                src="https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?q=80&w=1200&auto=format&fit=crop"
                alt="Direct premier ocean vessel space and automated container cargo terminal"
                fill
                sizes="(max-width: 768px) 100vw, 33vw"
                className="object-cover object-center group-hover:scale-108 transition-transform duration-1000 brightness-105"
              />
              ...
              <div className="relative z-10 p-6 space-y-3">
                ...
                <div className="glass-panel-dark p-3 rounded-xl border border-white/20 flex items-center justify-between text-xs backdrop-blur-md transition-all duration-300 group-hover:border-sky-400/40">
          ...
          <div className="md:col-span-12 lg:col-span-4 flex flex-col gap-6">
            ...
            <ScrollReveal effect="fade-up" delay={250} className="flex-1 flex">
              <div className="w-full rounded-3xl p-6 bg-[#0A2540]/80 border border-white/15 backdrop-blur-md flex flex-col justify-between group hover:border-sky-400/50 hover:shadow-xl hover-lift sheen-card transition-all duration-300">
                <div className="flex items-start justify-between mb-3">
                  <div className="w-11 h-11 rounded-xl bg-gradient-to-br from-emerald-400 to-[#0284C7] text-white flex items-center justify-center shadow-md shadow-emerald-500/20 group-hover:scale-110 group-hover:rotate-1 transition-all duration-300">
            ...
            <ScrollReveal effect="fade-up" delay={300} className="flex-1 flex">
              <div className="w-full rounded-3xl p-6 bg-[#0A2540]/80 border border-white/15 backdrop-blur-md flex flex-col justify-between group hover:border-sky-400/50 hover:shadow-xl hover-lift sheen-card transition-all duration-300">
                <div className="flex items-start justify-between mb-3">
                  <div className="w-11 h-11 rounded-xl bg-gradient-to-br from-cyan-400 to-[#0284C7] text-white flex items-center justify-center shadow-md shadow-cyan-500/20 group-hover:scale-110 group-hover:rotate-1 transition-all duration-300">
