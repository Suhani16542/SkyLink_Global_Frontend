...
export function Footer() {
  ...
  return (
    <footer className="mt-auto bg-[#07192D] text-neutral-300 border-t border-white/10">
      ...
      <div className="border-b border-white/10 bg-gradient-to-r from-[#0A2540] via-[#0B3156] to-[#0A2540] py-10">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex flex-wrap items-center gap-3">
            <Link
              ...
              className="inline-flex items-center gap-2 rounded-lg bg-[#0284C7] px-5 py-2.5 text-sm font-semibold text-white shadow-md hover:bg-[#0369A1] transition-all hover:scale-105"
            >
      ...
      <div className="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
          ...
          <div className="lg:col-span-2 space-y-5">
            ...
            <p className="text-sm sm:text-[15px] text-neutral-300 leading-relaxed max-w-sm font-normal">
          ...
          {/* Services Links */}
          <div>
            <h4 className="text-sm sm:text-[15px] font-bold uppercase tracking-wider text-white flex items-center gap-2">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2.5 text-sm sm:text-[15px]">
              ...
              <li className="pt-2">
                <Link
                  href="/admin/login"
                  className="inline-flex items-center gap-1.5 rounded bg-sky-950/60 border border-sky-800/60 px-3 py-1.5 text-xs font-semibold text-sky-300 hover:bg-sky-900 transition-colors"
                >
        ...
        {/* Bottom Legal bar */}
        <div className="mt-12 border-t border-white/10 pt-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs sm:text-sm text-neutral-400">
