  ...
  return (
    <footer className="mt-auto bg-[#07192D] text-neutral-300 border-t border-white/10">
      ...
      <div className="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2 text-xs">
              ...
              <li>
                <Link href="/request-consultation" className="hover:text-sky-300 transition-colors">
                  B2B Trade Audit
                </Link>
              </li>
              <li className="pt-2">
        ...
        {/* Bottom Legal bar */}
        <div className="mt-12 border-t border-white/10 pt-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-neutral-400">
