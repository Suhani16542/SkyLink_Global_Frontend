...
export default function AboutOverviewPage() {
  ...
  return (
    <div className="bg-white text-neutral-900 selection:bg-sky-500 selection:text-white overflow-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-10 items-center">
            <div className="lg:col-span-7 space-y-4 sm:space-y-4.5">
              <ScrollReveal effect="fade-up" delay={60}>
                <span className="inline-flex items-center gap-2 text-xs font-bold uppercase tracking-wider text-sky-400 bg-sky-400/10 px-3 py-1 rounded-full border border-sky-400/30 shadow-xs">
      ...
      {/* ========================================================================= */}
      {/* 2. VISION & MISSION (Both White Elegant Cards with Interactive Glow) */}
      {/* ========================================================================= */}
